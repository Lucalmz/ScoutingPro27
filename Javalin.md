...
# Javalin 7.2.3 — AI Coding Instructions
...
- Requires Java 17+
- Maven: `io.javalin:javalin:7.2.3`
- Bundle (includes Jackson, Logback, testing): `io.javalin:javalin-bundle:7.2.3`
...
Add a rendering engine artifact, e.g. `io.javalin:javalin-rendering-jte:7.2.3`:
